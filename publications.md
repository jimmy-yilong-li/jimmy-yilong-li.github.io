...
<section class="home-section publications-page">
  ...
  <div class="publication-page-list">
    <section class="publication-section-group" aria-labelledby="conference-papers">
      <h2 class="publication-section-heading" id="conference-papers">Conference Papers</h2>
      <div class="publication-section-list">
        {% for post in posts %}
          {% assign publication_year = post.date | date: "%Y" | plus: 0 %}
          {% if publication_year >= 2016 and post.publication_type != "journal" %}
    ...
    <section class="publication-section-group" aria-labelledby="journal-papers">
      <h2 class="publication-section-heading" id="journal-papers">Journal Papers</h2>
      <div class="publication-section-list">
        {% for post in posts %}
          {% assign publication_year = post.date | date: "%Y" | plus: 0 %}
          {% if publication_year >= 2016 and post.publication_type == "journal" %}
